...
var $author$project$Types$Hunger = 0;
...
var $author$project$Functions$actionScore = F2(
	function (needs, action) {
		var scoreMotivation = function (m) {
			var _v0 = A2(
...
var $author$project$Functions$getLocationById = F2(
		...
		if (!list.b) {
			...
			return $elm$core$Maybe$Just(
				A3(
					$elm$core$List$foldl,
					F2(
						function (item, currentMax) {
							return (_Utils_cmp(
								f(item),
								f(currentMax)) > 0) ? item : currentMax;
						}),
					x,
					xs));
		}
	...
	function (action, actor) {
		var applySatisfaction = function (need) {
			...
			if (!_v0.b) {
				...
				var sats = _v0;
				var totalSatisfaction = $elm$core$List$sum(
					A2(
						$elm$core$List$map,
						function ($) {
							return $.b6;
	...
	function (model, actor) {
		...
		if (!bestAction.$) {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Motivations:')
							])),
						A2(
						$elm$html$Html$ul,
						_List_Nil,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('All Options:')
							])),
						A2(
						$elm$html$Html$ul,
						_List_Nil,
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('No useful action to take.')
					]));
		}
	});
...
var $author$project$Main$viewActor = F2(
	function (model, actor) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('actor-container')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('section-column')
						]),
					_List_fromArray(
						[
							A2(
					...
					_List_fromArray(
						[
							...
							A2($author$project$Main$viewDecisionMaking, model, actor),
							A2(
							$elm$html$Html$h3,
							_List_Nil,
							_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('All Locations')
								])),
							A2(
							$elm$html$Html$ul,
							_List_Nil,
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Simulate Step')
					])),
			A2(
				$elm$core$List$map,
				function (a) {
					return A2($author$project$Main$viewActor, model, a);
				},
				model.ap)));
};
